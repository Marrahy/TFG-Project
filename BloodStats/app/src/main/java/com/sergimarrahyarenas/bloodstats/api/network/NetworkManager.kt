...
//import com.sergimarrahyarenas.api.models.characterstats.CharacterStatistics
...
//    suspend fun getCharacterStatistics(ACCESS_TOKEN: String, NAME: String, REALM: String?, gson: Gson): CharacterStatistics? = CoroutineScope(Dispatchers.IO).async {
//        val request = Request.Builder()
...
//            val responseBody = response.body!!.string()
//            val json = JSONObject(responseBody)
//            return@async CharacterStatistics()
//        } else {
//            null
//        }
//    }.await()
